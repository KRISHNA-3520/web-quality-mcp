    ...
    try {
        ...
        switch (name) {
            case "visual_regression":
                result = await visualTest(args as any);
                break;

            case "accessibility_audit":
                result = await accessibilityTest(args as any);
                break;

            case "performance_monitor":
                result = await performanceTest(args as any);
                break;

            case "content_verification":
                result = await contentCheck(args as any);
                break;

            case "link_checker":
                result = await linkCheck(args as any);
                break;
